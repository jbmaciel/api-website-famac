...
export interface ApiCourseCourse extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    image01: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::course.course'
    ...
    publishedAt: Schema.Attribute.DateTime;
    shift: Schema.Attribute.Enumeration<['Manh\u00E3', 'Tarde ', 'Noite']>;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    WhatsLink01: Schema.Attribute.String & Schema.Attribute.Required;
  };
}
...
export interface ApiHomeHome extends Struct.SingleTypeSchema {
  ...
  attributes: {
    areas: Schema.Attribute.DynamicZone<['shared.card']>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    section: Schema.Attribute.DynamicZone<
      ['shared.card', 'shared.tittle', 'shared.sub-head-l-ine']
    >;
    subHeadline: Schema.Attribute.Text;
    textCTA: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Entrar em Contato'>;
    titlePage: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Unopar Anhanguera'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
